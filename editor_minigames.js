(function () {
  ...
  Game.initMinigames = function () {
    ...
    (function () {
      ...
      M.gods = {
        ...
        decadence: {
          ...
          desc1:
            '<span class="green">' +
            loc("Golden and wrath cookie effect duration +%1%.", 7) +
            '</span> <span class="red">' +
            loc("Buildings grant -%1% CpS.", 7) +
            "</span>",
          desc2:
            '<span class="green">' +
            loc("Golden and wrath cookie effect duration +%1%.", 5) +
            '</span> <span class="red">' +
            loc("Buildings grant -%1% CpS.", 5) +
            "</span>",
          desc3:
            '<span class="green">' +
            loc("Golden and wrath cookie effect duration +%1%.", 2) +
            '</span> <span class="red">' +
            loc("Buildings grant -%1% CpS.", 2) +
            "</span>",
          quote:
        ...
        ages: {
          ...
          activeDescFunc: function () {
            ...
            if (godLvl == 1) {
              mult *=
                0.15 * Math.sin((now / 1000 / (60 * 60 * 3)) * Math.PI * 2);
            } else if (godLvl == 2) {
              mult *=
                0.15 * Math.sin((now / 1000 / (60 * 60 * 12)) * Math.PI * 2);
            } else if (godLvl == 3) {
              mult *=
                0.15 * Math.sin((now / 1000 / (60 * 60 * 24)) * Math.PI * 2);
            }
            return (
              loc("Current bonus:") +
              " " +
              (mult < 0 ? "-" : "+") +
              Game.Beautify(Math.abs(mult) * 100, 2) +
              "%"
            );
          },
          descBefore: loc(
            "CpS bonus fluctuating between %1 and %2 over time.",
            ['<span class="green">+15%</span>', '<span class="red">-15%</span>']
          ),
        ...
        seasons: {
          ...
          descBefore:
            '<span class="green">' +
            loc("Some seasonal effects are boosted.") +
            "</span>",
          desc1:
            '<span class="green">' +
            loc("Large boost.") +
            '</span> <span class="red">' +
            loc("Switching seasons is %1% pricier.", 100) +
            "</span>",
          desc2:
            '<span class="green">' +
            loc("Medium boost.") +
            '</span> <span class="red">' +
            loc("Switching seasons is %1% pricier.", 50) +
            "</span>",
          desc3:
            '<span class="green">' +
            loc("Small boost.") +
            '</span> <span class="red">' +
            loc("Switching seasons is %1% pricier.", 25) +
            "</span>",
          quote:
        ...
        creation: {
          ...
          desc1:
            '<span class="green">' +
            loc("All buildings are <b>%1% cheaper</b>.", 7) +
            '</span> <span class="red">' +
            loc("Heavenly chips have %1% less effect.", 30) +
            "</span>",
          desc2:
            '<span class="green">' +
            loc("All buildings are <b>%1% cheaper</b>.", 5) +
            '</span> <span class="red">' +
            loc("Heavenly chips have %1% less effect.", 20) +
            "</span>",
          desc3:
            '<span class="green">' +
            loc("All buildings are <b>%1% cheaper</b>.", 2) +
            '</span> <span class="red">' +
            loc("Heavenly chips have %1% less effect.", 10) +
            "</span>",
          quote:
        ...
        labor: {
          ...
          desc1:
            '<span class="green">' +
            loc("Clicking is <b>%1%</b> more powerful.", 15) +
            '</span> <span class="red">' +
            loc("Buildings produce %1% less.", 3) +
            "</span>",
          desc2:
            '<span class="green">' +
            loc("Clicking is <b>%1%</b> more powerful.", 10) +
            '</span> <span class="red">' +
            loc("Buildings produce %1% less.", 2) +
            "</span>",
          desc3:
            '<span class="green">' +
            loc("Clicking is <b>%1%</b> more powerful.", 5) +
            '</span> <span class="red">' +
            loc("Buildings produce %1% less.", 1) +
            "</span>",
        ...
        industry: {
          ...
          desc1:
            '<span class="green">' +
            loc("Buildings produce %1% more.", 10) +
            '</span> <span class="red">' +
            loc("Golden and wrath cookies appear %1% less.", 10) +
            "</span>",
          desc2:
            '<span class="green">' +
            loc("Buildings produce %1% more.", 6) +
            '</span> <span class="red">' +
            loc("Golden and wrath cookies appear %1% less.", 6) +
            "</span>",
          desc3:
            '<span class="green">' +
            loc("Buildings produce %1% more.", 3) +
            '</span> <span class="red">' +
            loc("Golden and wrath cookies appear %1% less.", 3) +
            "</span>",
          quote:
        ...
        mother: {
          ...
          desc1:
            '<span class="green">' +
            loc("Milk is <b>%1% more powerful</b>.", 10) +
            '</span> <span class="red">' +
            loc("Golden and wrath cookies appear %1% less.", 15) +
            "</span>",
          desc2:
            '<span class="green">' +
          ...
          desc3:
            '<span class="green">' +
            loc("Milk is <b>%1% more powerful</b>.", 3) +
            '</span> <span class="red">' +
            loc("Golden and wrath cookies appear %1% less.", 5) +
            "</span>",
          ...
          activeDescFunc: function () {
            if (Game.ObjectsOwned % 10 == 0) {
              return (
                loc("Buildings owned:") +
                " " +
                Game.Beautify(Game.ObjectsOwned) +
                "<br>" +
      ...
      byId("productDragonBoostPantheon").tooltipHTML =
        '<div class="productDragonBoostTooltip"><b>' +
      ...
      for (var key in M.gods) {
        ...
        godObj.key = key;
        godObj.name = loc(
          FindLocStringByPart("GOD " + (godObj.id + 1) + " NAME")
        );
        godObj.quote = loc(
          FindLocStringByPart("GOD " + (godObj.id + 1) + " QUOTE")
        );
        godObj.slot = -1;
      ...
      for (var i = 0; i < 3; i++) {
        $(
          '<div id="pantheonSlot' +
            i +
            '" class="templeGod templeGod' +
            i +
            ' templeSlot tooltipped" data-slot="' +
            i +
            '" data-god="-1">' +
            '<div id="pantheonSlot' +
            i +
            'Icon" class="usesIcon templeIcon hidden"></div>' +
            '<div class="usesIcon templeGem templeGem' +
            (i + 1) +
            '"></div></div>'
        ).appendTo("#pantheonSlots");
      }
      ...
      for (var name in M.gods) {
        ...
        godObj.$ele = $(
          '<div id="pantheonGod' +
            godObj.id +
            '" class="templeGod tooltipped" data-god="' +
            godObj.id +
            '"></div>'
        ).appendTo("#pantheonAvailable");
        godObj.$iconEle = $(
          '<div id="pantheonGod' +
            godObj.id +
            'Icon" class="usesIcon templeIcon"></div>'
        )
          .css(godObj.iconCss)
          .appendTo(godObj.$ele);
      }
      ...
      Game.updatePantheonSelection = function () {
        ...
        var cannotSet =
          slotId == -1 ||
          godId == -1 ||
          (slottedGod != -1 && slottedGod == godId);

        $("#pantheonClearSelection").toggleClass(
          "hidden",
          slotId == -1 && godId == -1
        );
        $("#pantheonSetGodFree").toggleClass("hidden", cannotSet);
        $("#pantheonSetGodSwap").toggleClass(
          "hidden",
          cannotSet || Game.pantheon.swapsIn.parsedValue < 1
        );
        $("#pantheonClearSlot").toggleClass(
          "hidden",
          slotId == -1 || slottedGod == -1
        );
      };
      ...
      byId("tabMinigames").onTabFunc = function () {
      ...
      Game.slotGod = function (godObj, slotId) {
        if (
          godObj &&
          godObj.key in Game.pantheon.gods &&
          slotId in Game.pantheon.slot
        ) {
      ...
      M.load = function (str) {
        ...
        Game.setInput(
          this.swapTimeIn,
          parseFloat(spl[i++] || Game.saveImportTime)
        );
      ...
      $("#pantheonBlock")
        ...
        .on("mouseenter", ".templeGod", function (ev) {
          ...
          if (godObj) {
            ...
            Game.setTooltip({
              html:
                '<div class="templeGodTooltip">' +
                '<div class="icon templeGodIcon" style="' +
                godObj.iconCssStr +
                '"></div>' +
                '<div class="name">' +
                godObj.name +
                "</div>" +
                '<div class="line"></div><div class="description"><div class="templeEffectHeader">' +
                loc("Effects:") +
                "</div>" +
                (godObj.slot > -1 && godObj.activeDescFunc
                  ? '<div class="templeEffect templeEffectOn templeEffectActive">' +
                    godObj.activeDescFunc() +
                    "</div>"
                  : "") +
                (godObj.descBefore
                  ? '<div class="templeEffect">' + godObj.descBefore + "</div>"
                  : "") +
                (godObj.desc1
                  ? '<div class="templeEffect templeEffect1' +
                    (slot == 0 ? " templeEffectOn" : "") +
                ...
                (godObj.desc3
                  ? '<div class="templeEffect templeEffect3' +
                    (slot == 2 ? " templeEffectOn" : "") +
                    '"><div class="usesIcon shadowFilter templeGem templeGem3"></div>' +
                    godObj.desc3 +
                    "</div>"
                  : "") +
                (godObj.descAfter
                  ? '<div class="templeEffect">' + godObj.descAfter + "</div>"
                  : "") +
      ...
      $("#pantheonClearSlot").on("click", function () {
        Game.clearGodSlot(
          $("#pantheonSlots .templeGod.selected").attr("data-slot")
        );
        Game.clearPantheonSelection();
        Game.scheduleUpdate();
      });
    ...
    (function () {
      ...
      byId("productDragonBoostGrimoire").tooltipHTML =
        '<div class="productDragonBoostTooltip"><b>' +
        loc("Supreme Intellect") +
        '</b><div class="line"></div>' +
        loc(
          "Grimoire spells are %1% cheaper but fail %1% more.",
          10 * Game.auraMult("Supreme Intellect")
        ) +
        "</div>";
      ...
      M.updateFunc = function () {
        ...
        this.magicPS =
          Math.max(
            0.002,
            Math.pow(this.magic / Math.max(this.magicMax, 100), 0.5)
          ) * 0.002;

        this.maxMagicSpan.innerHTML = Game.Beautify(Math.floor(this.magicMax));
        this.$magicPSSpan
          .html(
            " (+" + Game.Beautify((this.magicPS || 0) * Game.fps, 2) + "/s)"
          )
    ...
    (function () {
      ...
      M.nextStepIn.tooltipFunc = function () {
        ...
        if (this.freeze) {
          ...
          title =
            "Next tick in " +
            Game.sayTime(((this.nextStep - Date.now()) / 1000) * 30 + 30, -1);
        }
        return title;
      }.bind(M);
      ...
      byId("productDragonBoostGarden").tooltipHTML =
        '<div class="productDragonBoostTooltip"><b>' +
        loc("Supreme Intellect") +
        '</b><div class="line"></div>' +
        loc(
          "Garden plants age and mutate %1% faster.",
          5 * Game.auraMult("Supreme Intellect")
        ) +
        "</div>";
      ...
      M.plants = {
        ...
        thumbcorn: {
          ...
          effsStr:
            '<div class="green">&bull; ' + loc("cookies/click") + " +2%</div>",
        ...
        cronerice: {
          ...
          effsStr:
            '<div class="green">&bull; ' +
            loc("%1 CpS", Game.Objects["Grandma"].single) +
            " +3%</div>",
        ...
        gildmillet: {
          ...
          effsStr:
            '<div class="green">&bull; ' +
            loc("golden cookie gains") +
            ' +1%</div><div class="green">&bull; ' +
            loc("golden cookie effect duration") +
            " +0.1%</div>",
        ...
        elderwort: {
          ...
          effsStr:
            '<div class="green">&bull; ' +
            loc("wrath cookie gains") +
            ' +1%</div><div class="green">&bull; ' +
            loc("wrath cookie frequency") +
            ' +1%</div><div class="green">&bull; ' +
            loc("%1 CpS", Game.Objects["Grandma"].single) +
            ' +1%</div><div class="green">&bull; ' +
            loc("immortal") +
            '</div><div class="gray">&bull; ' +
        ...
        bakeberry: {
          ...
          effsStr:
            ...
            loc("CpS") +
            ' +1%</div><div class="green">&bull; ' +
            loc("harvest when mature for +%1 of CpS (max. %2% of bank)", [
              Game.sayTime(30 * 60 * Game.fps),
              3,
            ]) +
            "</div>",
        ...
        chocoroot: {
          ...
          effsStr:
            ...
            ' +1%</div><div class="green">&bull; ' +
            loc("harvest when mature for +%1 of CpS (max. %2% of bank)", [
              Game.sayTime(3 * 60 * Game.fps),
              3,
            ]) +
            '</div><div class="green">&bull; ' +
        ...
        whiteMildew: {
          ...
          effsStr:
            '<div class="green">&bull; ' +
            loc("CpS") +
            ' +1%</div><div class="gray">&bull; ' +
            loc("may spread as %1", loc("Brown mold")) +
            "</div>",
        ...
        brownMold: {
          ...
          effsStr:
            ...
            loc("CpS") +
            ' -1%</div><div class="gray">&bull; ' +
            loc("may spread as %1", loc("White mildew")) +
            "</div>",
        ...
        meddleweed: {
          ...
          contam: 0.05,
          detailsStr: EN
            ? "Grows in empty tiles, spreads easily"
            : Game.cap(loc("grows in empty tiles")) +
              " / " +
              Game.cap(loc("spreads easily")),
          children: ["meddleweed", "brownMold", "crumbspore"],
          effsStr:
            '<div class="red">&bull; ' +
            loc("useless") +
            '</div><div class="red">&bull; ' +
            loc("may overtake nearby plants") +
            '</div><div class="gray">&bull; ' +
            loc("may sometimes drop spores when uprooted") +
            "</div>",
        ...
        whiskerbloom: {
          ...
          effsStr:
            '<div class="green">&bull; ' + loc("milk effects") + " +0.2%</div>",
        ...
        nursetulip: {
          ...
          effsStr:
            '<div class="green">&bull; ' +
            loc("surrounding plants (%1x%1) are %2% more efficient", [3, 20]) +
            '</div><div class="red">&bull; ' +
            loc("CpS") +
            " -2%</div>",
        ...
        drowsyfern: {
          ...
          effsStr:
            '<div class="green">&bull; ' +
            loc("CpS") +
            ' +3%</div><div class="red">&bull; ' +
            loc("cookies/click") +
            ' -5%</div><div class="red">&bull; ' +
            loc("golden cookie frequency") +
            " -10%</div>",
        ...
        wardlichen: {
          ...
          effsStr:
            '<div class="gray">&bull; ' +
            loc("wrath cookie frequency") +
            ' -2%</div><div class="gray">&bull; ' +
            loc("wrinkler spawn rate") +
            " -15%</div>",
        ...
        keenmoss: {
          ...
          effsStr:
            '<div class="green">&bull; ' + loc("random drops") + " +3%</div>",
        ...
        queenbeet: {
          ...
          effsStr:
            '<div class="green">&bull; ' +
            loc("golden cookie effect duration") +
            ' +0.3%</div><div class="red">&bull; ' +
            loc("CpS") +
            ' -2%</div><div class="green">&bull; ' +
            loc("harvest when mature for +%1 of CpS (max. %2% of bank)", [
              Game.sayTime(60 * 60 * Game.fps),
              4,
            ]) +
        ...
        queenbeetLump: {
          ...
          effsStr:
            '<div class="red">&bull; ' +
            loc("CpS") +
            ' -10%</div><div class="red">&bull; ' +
            loc("surrounding plants (%1x%1) are %2% less efficient", [3, 20]) +
            '</div><div class="green">&bull; ' +
            loc("harvest when mature for a sugar lump") +
            "</div>",
        ...
        glovemorel: {
          ...
          effsStr:
            '<div class="green">&bull; ' +
            loc("cookies/click") +
            ' +4%</div><div class="green">&bull; ' +
            loc("%1 CpS", Game.Objects["Cursor"].single) +
            ' +1%</div><div class="red">&bull; ' +
            loc("CpS") +
            " -1%</div>",
        ...
        foolBolete: {
          ...
          effsStr:
            '<div class="green">&bull; ' +
            loc("golden cookie frequency") +
            ' +2%</div><div class="red">&bull; ' +
            loc("golden cookie gains") +
            ' -5%</div><div class="red">&bull; ' +
            loc("golden cookie duration") +
            ' -2%</div><div class="red">&bull; ' +
            loc("golden cookie effect duration") +
            " -2%</div>",
        ...
        shriekbulb: {
          ...
          noContam: true,
          detailsStr: Game.cap(
            loc("the unfortunate result of some plant combinations")
          ),
          children: ["shriekbulb"],
          effsStr:
            '<div class="red">&bull; ' +
            loc("CpS") +
            ' -2%</div><div class="red">&bull; ' +
            loc("surrounding plants (%1x%1) are %2% less efficient", [3, 5]) +
            "</div>",
        ...
        tidygrass: {
          ...
          effsStr:
            '<div class="green">&bull; ' +
            loc("surrounding tiles (%1x%1) develop no weeds or fungus", 5) +
            "</div>",
        ...
        everdaisy: {
          ...
          effsStr:
            '<div class="green">&bull; ' +
            loc("surrounding tiles (%1x%1) develop no weeds or fungus", 3) +
            '</div><div class="green">&bull; ' +
            loc("immortal") +
            "</div>",
        ...
        ichorpuff: {
          ...
          effsStr:
            '<div class="green">&bull; ' +
            loc("surrounding plants (%1x%1) age %2% slower", [3, 50]) +
            '</div><div class="red">&bull; ' +
            loc("surrounding plants (%1x%1) are %2% less efficient", [3, 50]) +
            "</div>",
      ...
      for (var i in M.plants) {
        ...
        if (typeof plant.plantable === "undefined") {
        ...
        plant.$seedBlock = $(
          '<div id="gardenSeed-' +
            n +
            '" class="gardenSeed gardenSelectable tooltipped" data-plant-id="' +
            n +
            '">' +
            '<div id="gardenSeedIcon-' +
            n +
            '" class="gardenSeedIcon" style="' +
            plant.iconCssStr[0] +
            '">' +
            "</div>"
        )
          .toggleClass("locked", !plant.unlocked)
          .appendTo("#gardenSeeds");
        n++;
      }
      ...
      M.computeMatures = function () {
        var mult = 1;
        if (Game.HasAchieve("Seedless to nay")) {
          mult = 0.95;
        }
      ...
      M.toggleGardenFillBtn = function () {
        $("#gardenFillAllPlots").toggleClass(
          "hidden",
          this.getNewSeedAge(this.plantsById[this.seedSelected]) < 0
        );
      };
      ...
      M.toggleSeed = function (plant, toggle) {
        toggle =
          typeof toggle === "undefined" ? !plant.unlocked : Boolean(toggle);
      ...
      M.getCost = function (plant) {
        ...
        return (
          Math.max(plant.costM, Game.cookiesPs * plant.cost * 60) *
          (Game.HasAchieve("Seedless to nay") ? 0.95 : 1)
        );
      };
      ...
      M.getPlantDesc = function (plant) {
        ...
        if (plant.children.length > 0) {
          ...
          for (var i = 0; i < plant.children.length; i++) {
            ...
            if (!it) {
              console.log("No plant named " + plant.children[i]);
            }
            if (it) {
              children +=
                '<div class="gardenSeedTiny' +
                (it.unlocked ? '" style="' + it.iconCssStr[0] : " locked") +
                '"></div>';
            }
          }
          children += "</div>";
        ...
        return (
          ...
          (!plant.immortal
            ? '<div class="gardenDescMargin gardenDescFont"><b>' +
              loc("Average lifespan:") +
              "</b> " +
              Game.sayTime(
                (100 / (plant.ageTick + plant.ageTickR / 2)) *
                  dragonBoost *
                  M.stepT *
                  30,
                -1
              ...
              loc(
                "%1 tick",
                Game.LBeautify(
                  Math.ceil((100 / (plant.ageTick + plant.ageTickR / 2)) * 1)
                )
              ) +
              ")</small></div>"
            : "") +
          '<div class="gardenDescMargin gardenDescFont"><b>' +
          loc("Average maturation:") +
          "</b> " +
          Game.sayTime(
            (100 / (plant.ageTick + plant.ageTickR / 2)) *
              (plant.mature / 100) *
          ...
          (plant.weed
            ? '<div class="gardenDescMargin gardenDescFont"><b>' +
              (EN ? "Is a weed" : loc("Weed")) +
              "</b></div>"
            : "") +
          (plant.fungus
            ? '<div class="gardenDescMargin gardenDescFont"><b>' +
              (EN ? "Is a fungus" : loc("Fungus")) +
              "</b></div>"
            : "") +
          (plant.detailsStr
            ? '<div class="gardenDescMargin gardenDescFont"><b>' +
          ...
          (children != ""
            ? '<div class="gardenDescMargin gardenDescFont"><b>' +
              loc("Possible mutations:") +
              "</b> " +
              children +
              "</div>"
            : "") +
          '<div class="line"></div>' +
          '<div class="gardenDescMargin"><b>' +
          loc("Effects:") +
          '</b> <span class="gardenDescFont">(' +
          loc("while plant is alive; scales with plant growth") +
          +"</b></div>" +
          '<div class="gardenDescFont bold">' +
          plant.effsStr +
          "</div>" +
          (plant.q ? "<q>" + plant.q + "</q>" : "") +
          "</div>"
      ...
      M.soils = {
        dirt: {
          ...
          effsStr:
            ...
            loc(
              "tick every %1",
              "<b>" + Game.sayTime(5 * 60 * Game.fps) + "</b>"
            ) +
            "</div>",
        ...
        fertilizer: {
          ...
          effsStr:
            ...
            loc(
              "tick every %1",
              "<b>" + Game.sayTime(3 * 60 * Game.fps) + "</b>"
            ) +
            '</div><div class="red">&bull; ' +
            loc("passive plant effects") +
            ' <b>-25%</b></div><div class="red">&bull; ' +
            loc("weed growth") +
            " <b>+20%</b></div>",
          q: loc(
        ...
        clay: {
          ...
          effsStr:
            ...
            loc(
              "tick every %1",
              "<b>" + Game.sayTime(15 * 60 * Game.fps) + "</b>"
            ) +
            '</div><div class="green">&bull; ' +
            loc("passive plant effects") +
            " <b>+25%</b></div>",
        ...
        pebbles: {
          ...
          effsStr:
            ...
            '</div><div class="red">&bull; ' +
            loc("passive plant effects") +
            ' <b>-75%</b></div><div class="green">&bull; ' +
            loc(
        ...
        woodchips: {
          ...
          effsStr:
            ...
            loc("passive plant effects") +
            ' <b>-75%</b></div><div class="green">&bull; ' +
            loc("plants spread and mutate <b>%1 times more</b>", 3) +
            '</div><div class="green">&bull; ' +
            loc("weed growth") +
            " <b>-90%</b></div>",
          q: loc(
      ...
      for (i in M.soils) {
        ...
        soil.$soilBlock = $(
          '<div id="gardenSoil-' +
            n +
            '" class="gardenSeed gardenSoil gardenSelectable tooltipped" data-soil-id="' +
            n +
            '">' +
      ...
      M.toggleSoil = function (id) {
        ...
        if (
          this.resetLockedSoil &&
          soil &&
          id > 0 &&
          this.parent.amount < soil.req
        ) {
      ...
      M.getNextSoilText = function (now) {
        ...
        if (this.nextSoil > now) {
          str =
            ...
            Game.sayTime(((this.nextSoil - now) / 1000) * 30 + 30, -1) +
            ".";
        }
        return str;
      };
        ...
        for (var x = 0; x < 6; x++) {
          ...
          $(
            '<div id="gardenTile-' +
              ...
              "-" +
              y +
              '" class="gardenTile tooltipped hidden" style="left:' +
              (16 + x * M.tileSize) +
              "px;top:" +
              (16 + y * M.tileSize) +
              'px;">' +
              ...
              "-" +
              y +
              '" class="gardenTileIcon gardenSelectable hidden"></div>' +
              "</div>"
          ).appendTo("#gardenPlot");
        }
      }
      ...
      M.isTileUnlocked = function (x, y) {
        ...
        return (
          x >= limits[0] && x < limits[2] && y >= limits[1] && y < limits[3]
        );
      };
      ...
      M.setPlotTile = function (x, y, id, age, keepSelection) {
        ...
        if (this.plot[y] && this.plot[y][x]) {
          ...
          if (
            !keepSelection &&
            this.plotTileSelected &&
            this.plotTileSelected[0] == x &&
            this.plotTileSelected[1] == y
          ) {
      ...
      M.updatePlotTile = function (x, y) {
        if (this.plot[y] && this.plot[y][x]) {
          ...
          if (plant) {
            ...
            if (age >= plant.mature) {
              stage = 4;
            } else if (age >= plant.mature * 0.666) {
              stage = 3;
            } else if (age >= plant.mature * 0.333) {
              stage = 2;
            } else {
              stage = 1;
            }
          ...
          $("#gardenTileIcon-" + x + "-" + y)
            .toggleClass("hidden", id < 0)
            .toggleClass("dying", dying)
            .css(css);
        }
      };
      ...
      M.selectPlotTile = function (x, y, toggle) {
        ...
        if (tile && tile[0] > 0) {
          var $icon = $("#gardenTileIcon-" + x + "-" + y).toggleClass(
            "on",
            toggle
          );
          ...
          if ($icon.hasClass("on")) {
            ...
            visible = true;
            byId("gardenSelPlotName").textContent =
              this.plantsById[tile[0] - 1].name;
        ...
        $("#gardenDeselectPlot, #gardenSelPlotBlock").toggleClass(
          "invisible",
          !visible
        );
      };
      ...
      M.tileTooltip = function (x, y) {
        ...
        var boostStr =
          (M.plotBoost[y][x][0] != 1
            ? "<br><small>" +
              loc("Aging multiplier:") +
              " " +
              Game.Beautify(M.plotBoost[y][x][0] * 100) +
              "%</small>"
            : "") +
          (M.plotBoost[y][x][1] != 1
            ? "<br><small>" +
              loc("Effect multiplier:") +
              " " +
              Game.Beautify(M.plotBoost[y][x][1] * 100) +
              "%</small>"
            : "") +
          (M.plotBoost[y][x][2] != 1
            ? "<br><small>" +
              loc("Weeds/fungus repellent:") +
              " " +
              Game.Beautify(100 - M.plotBoost[y][x][2] * 100) +
              "%</small>"
            : "");
        ...
        if (tile[0] == 0) {
          ...
          str =
            '<div class="alignCenter" style="padding:8px 4px;min-width:350px;">' +
            '<div class="name">' +
            loc("Empty tile") +
            "</div>" +
          ...
          if (tile[1] >= plant.mature) {
            stage = 4;
          } else if (tile[1] >= plant.mature * 0.666) {
            stage = 3;
          } else if (tile[1] >= plant.mature * 0.333) {
            stage = 2;
          } else {
            stage = 1;
          }
          ...
          var dragonBoost = 1 / (1 + 0.05 * Game.auraMult("Supreme Intellect"));
          str =
            '<div class="minigameTooltip">' +
            '<div class="icon" style="background:url(img/gardenPlants.png);float:left;margin-left:-8px;margin-top:-8px;' +
            plant.iconCssStr[stage] +
            '"></div>' +
            '<div class="name">' +
            plant.name +
            "</div><div><small>" +
            loc("This plant is growing here.") +
            "</small></div>" +
            '<div class="line"></div>' +
            '<div class="alignCenter">' +
            '<div class="gardenGrowthLine" style="background:linear-gradient(to right, #ffffff 0%, #00ff99 ' +
            plant.mature +
            "%, #33cc00 " +
            (plant.mature + 0.1) +
            '%, #996600 100%)">' +
            ...
            'px;"></div>' +
            '<div class="gardenGrowthIcon" style="' +
            plant.iconCssStr[1] +
            "left:" +
            (0 - 24) +
            'px;"></div>' +
            ...
            plant.iconCssStr[2] +
            "left:" +
            (((plant.mature * 0.333) / 100) * 256 - 24) +
            'px;"></div>' +
            '<div class="gardenGrowthIcon" style="' +
            plant.iconCssStr[3] +
            "left:" +
            (((plant.mature * 0.666) / 100) * 256 - 24) +
            'px;"></div>' +
            '<div class="gardenGrowthIcon" style="' +
            plant.iconCssStr[4] +
            "left:" +
            ((plant.mature / 100) * 256 - 24) +
            'px;"></div>' +
            "</div><br>" +
            "<b>" +
            loc("Stage:") +
            "</b> " +
            loc(["bud", "sprout", "bloom", "mature"][stage - 1]) +
            "<br>" +
            "<small>" +
            (stage == 1
              ? loc("Plant effects:") + " 10%"
              : stage == 2
              ? loc("Plant effects:") + " 25%"
              : stage == 3
              ? loc("Plant effects:") + " 50%"
              : loc("Plant effects:") +
                " 100%; " +
                loc("may reproduce, will drop seed when harvested")) +
            "</small>" +
            "<br><small>";
            ...
            str +=
              loc(
                ...
                Game.sayTime(
                  (100 /
                    (M.plotBoost[y][x][0] *
                      (plant.ageTick + plant.ageTickR / 2))) *
                    ((plant.mature - tile[1]) / 100) *
                    dragonBoost *
                    M.stepT *
                    30,
                  -1
          ...
          for (var y = 0; y < 6; y++) {
            for (var x = 0; x < 6; x++) {
              ...
              if (tile[0] > 0) {
                ...
                if (tile[1] >= me.mature) {
                  stage = 4;
                } else if (tile[1] >= me.mature * 0.666) {
                  stage = 3;
                } else if (tile[1] >= me.mature * 0.333) {
                  stage = 2;
                } else {
                  stage = 1;
                }
                ...
                if (name == "bakerWheat") {
                  effs.cps += 0.01 * mult;
                } else if (name == "thumbcorn") {
                  effs.click += 0.02 * mult;
                } else if (name == "cronerice") {
                  effs.grandmaCps += 0.03 * mult;
                ...
                } else if (name == "bakeberry") {
                  effs.cps += 0.01 * mult;
                } else if (name == "chocoroot") {
                  effs.cps += 0.01 * mult;
                } else if (name == "whiteChocoroot") {
                  effs.goldenCookieGain += 0.01 * mult;
                } else if (name == "whiteMildew") {
                  effs.cps += 0.01 * mult;
                } else if (name == "brownMold") {
                  effs.cps *= 1 - 0.01 * mult;
                }

                // else if (name == "meddleweed") {}
                else if (name == "whiskerbloom") {
                  effs.milk += 0.002 * mult;
      ...
      byId("gardenFreezeTool").setTitleFunc = function () {
        this.dataset.title =
          '<div class="alignCenter">' +
          loc(
            "Cryogenically preserve your garden.<br>Plants no longer grow, spread or die; they provide no benefits.<br>" +
              'Soil cannot be changed.<div class="line"></div>Using this will effectively pause your garden.'
          ) +
          "</div>";
      };
        ...
        if (M.freeze) {
          ...
          for (var i in M.effsData) {
            if (M.effs[i] != 1 && M.effsData[i]) {
              ...
              effStr +=
                '<div style="font-size:10px"><b>&bull; ' +
                M.effsData[i].n +
                '</b> <span class="' +
                (amount * (M.effsData[i].rev ? -1 : 1) > 0 ? "green" : "red") +
                '">' +
                (amount > 0 ? "+" : "-") +
                Game.Beautify(Math.abs(M.effs[i] - 1) * 100, 2) +
                "%</span></div>";
            }
          }
          if (effStr == "") {
            effStr =
              '<div style="font-size:10px;"><b>' + loc("None.") + "</b></div>";
          }
          str +=
            "<div>" +
            loc("Combined effects of all your plants:") +
            "</div>" +
            effStr;
        }
          ...
          for (var y = 0; y < 6; y++) {
            for (var x = 0; x < 6; x++) {
              this.setPlotTile(
                x,
                y,
                parseInt(plot[n], 10) - 1,
                parseInt(plot[n + 1], 10)
              );
              n += 2;
            }
          }
      ...
      M.updateFunc = function () {
        ...
        $("#gardenNumSeeds").text(
          "(" + this.numPlantsUnlocked + " / " + this.numPlants + ")"
        );
        $("#gardenLockAllSeeds").toggleClass(
          "hidden",
          this.numPlantsUnlocked <= 1
        );
        $("#gardenUnlockAllSeeds").toggleClass(
          "hidden",
          this.numPlantsUnlocked >= this.numPlants
        );
        ...
        if (
          this.plotTileSelected &&
          !this.isTileUnlocked(
            this.plotTileSelected[0],
            this.plotTileSelected[1]
          )
        ) {
          this.selectPlotTile(null);
        }
      ...
      $("#gardenSeedBlock")
        .on("click", ".gardenSeed", function (ev) {
        ...
        .on("mouseenter", ".gardenSeed", function (ev) {
          ...
          if (plant) {
            Game.setTooltip({
              html:
                '<div class="gardenSeedTooltip">' +
                '<div class="icon gardenLineIcon" style="margin-left:-24px;margin-top:-4px;' +
                plant.iconCssStr[0] +
                '"></div>' +
                '<div class="icon gardenLineIcon" style="margin-left:-24px;margin-top:-28px;' +
                plant.iconCssStr[4] +
                '"></div>' +
                '<div class="turnInto"></div>' +
                (plant.plantable
                  ? '<div class="gardenSeedTooltipCost"><small>' +
                    loc("Planting cost:") +
                    "</small><br>" +
                    '<span class="priceIcon">' +
                    Game.BeautifyAbbr(
                      Math.round(Game.shortenNumber(M.getCost(plant)))
                    ) +
                    "</span><br>" +
                    "<small>" +
                    loc("%1 of CpS,<br>minimum %2", [
                      Game.sayTime(plant.cost * 60 * 30, -1),
                      loc("%1 cookie", Game.LBeautify(plant.costM)),
                    ]) +
                    "</small></div>"
                  : "") +
                ...
                " seed</div><div><small>" +
                (plant.plantable
                  ? loc("Click to select this seed for planting.")
                  : '<span class="red">' +
                    loc("This seed cannot be planted.") +
                    "</span>") +
                "<!--<br>" +
                loc(
                  "%1 to harvest all mature plants of this type.",
                  loc("Shift") + "+" + loc("Ctrl") + "+" + loc("Click")
                ) +
                "--></small></div></div>" +
                '<div class="line"></div>' +
                M.getPlantDesc(plant) +
      ...
      $("#gardenSoilBlock")
        .on("mouseenter", ".gardenSoil", function (ev) {
          var M = Game.garden;
          ...
          if (soil) {
            ...
            var str =
              '<div class="minigameTooltip">' +
              '<div class="icon gardenLineIcon" style="margin-left:-8px;margin-top:-8px;' +
              soil.iconCssStr +
              '"></div>' +
              '<div><div class="name">' +
              soil.name +
        ...
        .on("click", ".gardenSoil", function () {
          ...
          if (
            soil &&
            Game.garden.soil !== soil.id &&
            (!Game.garden.resetLockedSoil ||
              Game.garden.parent.amount >= soil.req)
          ) {
      ...
      $("#gardenBlock")
        .on("click", '[name="gardenSeedAge"]', function () {
      ...
      $("#gardenNextStepSet").on("click", function () {
        Game.setInput(
          Game.garden.nextStepIn,
          Date.now() + Game.garden.stepT * 1000
        );
        Game.scheduleUpdate();
      });
      ...
      $("#gardenNextSoilSet").on("click", function () {
        Game.setInput(
          Game.garden.nextSoilIn,
          Date.now() +
            (Game.HasUpgrade("Turbo-charged soil") ? 1 : 1000 * 60 * 10)
        );
        Game.scheduleUpdate();
      });
        ...
        if (selPlot) {
          ...
          if (tile) {
            M.setPlotTile(
              ...
              y,
              tile[0] - 1,
              byId("gardenSelPlotAgeIn").parsedValue,
              true
            );
          }
        }
    ...
    (function () {
      ...
      M.goodDelta = function (id, back) {
        //if back is 0 we get the current step; else get current step -back
        back = back || 0;
      ...
      M.getGoodMaxStock = function (good) {
        ...
        return Math.ceil(
          good.building.highest * (M.officeLevel > 4 ? 1.5 : 1) +
            bonus +
            good.building.level * 10
        );
      };
      ...
      var goodTooltip = function () {
        ...
        this.tooltipHTML =
          '<div class="minigameTooltip">' +
          '<div class="icon tooltipIcon" style="' +
          good.iconCssStr +
          '"></div>' +
          '<div class="name">' +
          name +
          ' <span class="bankFromName">(' +
          loc(
            "from %1",
            '<span class="smallcaps">' +
              good.company.replace("%1", Game.bakeryName) +
              "</span>"
          ) +
          ...
          (EN
            ? "<q>" +
              good.desc.replace("%1", Game.bakeryName) +
              "</q>" +
              '<div class="line"></div>'
            : "") +
          '<div class="line"></div><div class="bankSmallText">&bull; <div class="icon tinyIcon" style="' +
          good.iconCssStr +
          '"></div> ' +
          loc("%1: currently worth <b>$%2</b> per unit.", [
            name,
            Game.Beautify(good.val, 2),
          ]) +
          "</b> per unit.<br>&bull; " +
          loc("You currently own %1 (worth <b>$%2</b>).", [
            '<div class="icon tinyIcon" style="' +
              good.iconCssStr +
              '"></div> <b>' +
              Game.BeautifyAbbr(good.stock) +
              "</b>x " +
              name,
            Game.BeautifyAbbr(good.val * good.stock, 2),
          ]) +
          "</b>).<br>&bull; " +
          loc(
            ...
            '<div class="icon tinyIcon" style="' +
              good.iconCssStr +
              '"></div> <b>' +
              Game.BeautifyAbbr(M.getGoodMaxStock(good)) +
              "</b>x " +
              name
          ) +
          ".<br>&bull; " +
          loc(
            ...
            [
              '<div class="icon tinyIcon" style="' +
                Game.getIconCssStr([good.building.iconColumn, 0]) +
                '"></div> ' +
                good.building.plural,
              10,
              good.building.single,
              good.building.level * 10,
            ]
          ) +
          "</b>).<br>&bull; " +
      ...
      for (i in M.goods) {
        ...
        good.id = n;
        good.name = loc(
          FindLocStringByPart("STOCK " + (good.id + 1) + " TYPE")
        );
        good.company = loc(
          FindLocStringByPart("STOCK " + (good.id + 1) + " NAME")
        );
        good.symbol = loc(
          FindLocStringByPart("STOCK " + (good.id + 1) + " LOGO")
        );
        good.active = false;
        ...
        good.$row = $(
          '<tr class="marketGoodRow" data-title>' +
            '<td class="marketGoodName"><div class="icon tinyIcon" style="' +
            good.iconCssStr +
            '"></div> <span class="marketGoodNameSpan">' +
            good.name +
            "</span> (" +
            good.symbol +
            ")</td>" +
            ...
            '<td>"Mode" <select class="marketGoodMode">' +
            modeSelHTML +
            "</select></td>" +
            ...
            "</tr>"
        ).appendTo("#marketGoodsList");
        good.$row
          .find("input, select, .marketGoodReroll")
          .add(good.$row)
          .attr("data-good", good.id);
      ...
      M.offices = [
        {
          name: loc("Credit garage"),
          icon: [0, 33],
          cost: [100, 2],
          desc: EN
            ? "This is your starting office."
            : loc("This is your office.") +
              "<br>" +
              loc("Upgrading will grant you:") +
              "<br><b><!--&bull; " +
              loc("+1 opportunity slot") +
              "<br>-->&bull; " +
              loc("+%1 warehouse space for all goods", 25) +
              "</b>",
        },
        {
          name: loc("Tiny bank"),
        ...
        },
        {
          ...
          desc:
            ...
            loc("+1 opportunity slot") +
            "<br>-->&bull; " +
            loc("+%1 warehouse space for all goods", 75) +
            "</b>",
        },
        {
          name: loc("Finance headquarters"),
          icon: [11, 33],
          cost: [500, 10],
          desc:
            loc("This is your office.") +
        ...
        {
          name: loc("International exchange"),
          icon: [12, 33],
          cost: [700, 12],
          desc:
            loc("This is your office.") +
      ...
      M.getMaxBrokers = function () {
        return Math.ceil(
          Game.Objects["Grandma"].highest / 10 + Game.Objects["Grandma"].level
        );
      };
      M.getBrokerPrice = function () {
        return Game.rawCookiesPsHighest * 60 * 20;
      };

      M.graphLinesChk = byId("marketGraphLines");
      M.graphColorChk = byId("marketGraphColor");

      byId("productDragonBoostMarket").tooltipHTML =
        '<div class="productDragonBoostTooltip"><b>' +
        loc("Supreme Intellect") +
        '</b><div class="line"></div>' +
        loc("The stock market is more chaotic.") +
        "</div>";
      ...
      M.updateFunc = function () {
        M.officeLevel = Game.getSelectedIndex(
          M.officeLevelSel,
          M.offices.length - 1
        );
        $("#marketOfficeIcon").css(M.offices[M.officeLevel].iconCss);

        byId("marketBrokersLimit").innerHTML = Game.BeautifyAbbr(
          M.getMaxBrokers()
        );
        ...
        for (var i = 0; i < M.goodsById.length; i++) {
          ...
          good.$row.toggleClass(
            "bankGoodInactive",
            !good.active || good.hiddenChk.checked
          );
      ...
      byId("marketOfficeBlock").setTitleFunc = function () {
        ...
        this.tooltipHTML =
          ...
          '<div class="name">' +
          office.name +
          ' <span class="bankSmallText" style="opacity:0.6;">[' +
          loc("Level %1 offices", M.officeLevel + 1) +
          "]</span></div>" +
          '<div class="line"></div><div class="description bankSmallText">' +
          office.desc +
          "</div>" +
          (office.cost
            ? '<div class="line"></div><div class="bankSmallText" style="padding-left: 24px; position: relative;">' +
              '<div id="bankOfficeIcon" class="icon tinyIcon" style="position: absolute; left: 0; top: 6px;' +
              Game.getIconCssStr([11, 0]) +
              '"></div>' +
              loc(
      ...
      byId("marketBrokersBlock").setTitleFunc = function () {
        this.tooltipHTML =
          '<div class="minigameTooltip">' +
          '<div class="icon tooltipIcon" style="' +
          Game.getIconCssStr([1, 33]) +
          '"></div>' +
          '<div class="name">' +
          (EN
            ? 'Stockbrokers <span class="bankSmallText" style="opacity:0.6;">(you have ' +
              Game.BeautifyAbbr(M.brokers) +
              ")</span>"
            : loc("Brokers:") + " " + Game.Beautify(M.brokers)) +
          "</div>" +
          '<div class="line"></div><div class="description bankSmallText">' +
          ...
          loc(
            ...
            Game.Beautify(20 * Math.pow(0.95, M.brokers), 2)
          ) +
          "<br>" +
          "&bull; " +
          loc("Buying a broker costs %1 of CpS (that's $%2).", [
            '<b class="hasTinyCookie ' +
              (Game.cookies >= M.getBrokerPrice() ? "green" : "red") +
              '">' +
              loc("%1 minute", Game.LBeautify(20)) +
              "</b>",
            1200,
          ]) +
          "<br>" +
          ...
          loc(
            ...
            '<b class="hasTinyCookie ' +
              (Game.cookies >= M.getBrokerPrice() ? "green" : "red") +
              '">' +
              loc("%1 cookie", Game.LBeautify(M.getBrokerPrice())) +
              "</b>"
          ) +
          "</div>" +
          "</div>" +
      ...
      byId("marketGoodsHelp").dataset.title =
        '"Mode" and "Dur" affect the randomness of stock value changes in ways that frankly I don\'t really want to figure out or explain. The game shouldn\'t break from editing them at least.';
    })();
    //#endregion Stonks
  };
})();
